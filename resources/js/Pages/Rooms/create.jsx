...
export default function Create() {
    ...
    return (
        <AuthenticatedLayout
            header={<h2 className="text-lg font-semibold text-gray-800">Yangi xona qo'shish</h2>}
        >
            <Head title="Xona qo'shish" />
            ...
            <div className="max-w-2xl mx-auto">
                <form onSubmit={submit} className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 space-y-4">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        <div>
                            <label className="block text-sm text-gray-600 mb-1">Sig'imi (o'rin soni)</label>
                            <input
                                type="number"
                                min="1"
                                value={data.capacity}
                        ...
                        <div>
                            ...
                            <input
                                ...
                                placeholder="0"
                            />
                            {errors.occupied && <p className="text-red-500 text-xs mt-1">{errors.occupied}</p>}
                        </div>
                    </div>
